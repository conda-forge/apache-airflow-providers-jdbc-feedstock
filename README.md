About apache-airflow-providers-jdbc-feedstock
=============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-jdbc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-jdbc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-jdbc
# for installing globally
pixi global install apache-airflow-providers-jdbc
```
...
It is possible to list all of the versions of `apache-airflow-providers-jdbc` available on your platform:
...
```
pixi search apache-airflow-providers-jdbc --channel conda-forge
```
